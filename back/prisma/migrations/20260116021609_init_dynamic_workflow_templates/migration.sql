...
CREATE TABLE `engagements` (
    ...
    `parentEngagementId` VARCHAR(191) NULL,
    ...
    INDEX `engagements_workflowTemplateId_idx`(`workflowTemplateId`),
    INDEX `engagements_workflowStepId_idx`(`workflowStepId`),
    INDEX `engagements_parentEngagementId_idx`(`parentEngagementId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `workflow_templates` (
    ...
    INDEX `workflow_templates_code_idx`(`code`),
    INDEX `workflow_templates_isActive_idx`(`isActive`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `workflow_steps` (
    ...
    `approvalRoles` JSON NULL,
    `triggerAction` VARCHAR(191) NULL,
    `icon` VARCHAR(191) NULL,
    `color` VARCHAR(191) NULL,
    ...
    INDEX `workflow_steps_templateId_idx`(`templateId`),
    INDEX `workflow_steps_code_idx`(`code`),
    UNIQUE INDEX `workflow_steps_templateId_stepOrder_key`(`templateId`, `stepOrder`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `engagements` ADD CONSTRAINT `engagements_workflowTemplateId_fkey` FOREIGN KEY (`workflowTemplateId`) REFERENCES `workflow_templates`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `engagements` ADD CONSTRAINT `engagements_workflowStepId_fkey` FOREIGN KEY (`workflowStepId`) REFERENCES `workflow_steps`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `engagements` ADD CONSTRAINT `engagements_parentEngagementId_fkey` FOREIGN KEY (`parentEngagementId`) REFERENCES `engagements`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
